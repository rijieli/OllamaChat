...
func sendPrompt(host: String, prompt: PromptModel, timeoutRequest: String, timeoutResource: String)
...
func getLocalModels(host: String, timeoutRequest: String, timeoutResource: String) async throws
    -> ModelGroup
{
